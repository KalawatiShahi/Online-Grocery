      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        {!user ? (
          <button
            ...
            className="px-8 py-2 bg-primary-dull hover:bg-primary text-white rounded-full transition"
          >
            Login
          </button>
        ) : (
        ...
        <div className="absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex flex-col items-start gap-2 px-5 text-sm sm:hidden z-40">
          ...
          {!user ? (
            <button
              ...
              className="px-6 py-2 mt-2 bg-primary-dull hover:bg-primary text-white rounded-full text-sm"
            >
              Login
            </button>
          ) : (
