    ...
    <div className='relative'>
      ...
      <div className='flex items-center  mt-6 font-medium'>
        ...
        <img className='md:hidden transition group-focus:translate-x-1' src={assets.white_arrow_icon} alt='arrow' />
         ...
         <Link to={"/products"} className='group hidden md:flex items-center gap-2 px-9 py-3 cursor-center'>
        Explore deals
        <img className='transition hover:translate-x-1' src={assets.black_arrow_icon} alt='arrow' />
        </Link>
      </div>
      </div>
      </div>
